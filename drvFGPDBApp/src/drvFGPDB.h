...
class drvFGPDB : public asynPortDriver {
  ...
  public:
    ...
    /**
     * @brief Event-timer callback wrapper func to maintain write access
     *
     * @param[in]  obj  pointer to drvFGPDB object
     *
     * @return > 0: Use returned time until next callback
     *           0: Use Default time until next callback
     *         < 0: Sleep unless/until woken up
     */
    static double keepWriteAccess_(void *obj)  {
       return static_cast<drvFGPDB *>(obj)->keepWriteAccess(); }

    /**
     * @brief Event-timer callback wrapper func to update scalar readings
     *
     * @return > 0: Use returned time until next callback
     *           0: Use Default time until next callback
     *         < 0: Sleep unless/until woken up
     */
    static double processScalarReads_(void *obj)  {
       return static_cast<drvFGPDB *>(obj)->processScalarReads(); }

    /**
     * @brief Event-timer callback wrapper func to prcoess pending writes to
     *        scalar values
     *
     * @return > 0: Use returned time until next callback
     *           0: Use Default time until next callback
     *         < 0: Sleep unless/until woken up
     */
    static double processScalarWrites_(void *obj)  {
       return static_cast<drvFGPDB *>(obj)->processScalarWrites(); }

    /**
     * @brief Event-timer callback wrapper func to prcoess pending/ongoing
     *        reads of array values
     *
     * @return > 0: Use returned time until next callback
     *           0: Use Default time until next callback
     *         < 0: Sleep unless/until woken up
     */
    static double processArrayReads_(void *obj)  {
       return static_cast<drvFGPDB *>(obj)->processArrayReads(); }

    /**
     * @brief Event-timer callback wrapper func to prcoess pending/ongoing
     *        writes to array values
     *
     * @return > 0: Use returned time until next callback
     *           0: Use Default time until next callback
     *         < 0: Sleep unless/until woken up
     */
    static double processArrayWrites_(void *obj)  {
       return static_cast<drvFGPDB *>(obj)->processArrayWrites(); }

    /**
     * @brief Event-timer callback wrapper func to post the latest readings.
     *
     * @return > 0: Use returned time until next callback
     *           0: Use Default time until next callback
     *         < 0: Sleep unless/until woken up
     */
    static double postNewReadings_(void *obj)  {
       return static_cast<drvFGPDB *>(obj)->postNewReadings(); }

    /**
     * @brief Event-timer callback wrapper func to update the status of the
     ...
     *         < 0: Sleep unless/until woken up
     */
    static double checkComStatus_(void *obj)  {
       return static_cast<drvFGPDB *>(obj)->checkComStatus(); }
